...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    for i in range(len(data)):
        ...
        for j in range(len(measures)):
            ...
            for b in range(2):
                Omega.value[k+b][k+b] += 1/measurement_noise
                Omega.value[k+b][mm+b] += -1/measurement_noise
                Omega.value[mm+b][k+b] += -1/measurement_noise
                Omega.value[mm+b][mm+b] += 1/measurement_noise
                Xi.value[k+b][0] += -dmeasure[b]/measurement_noise
                Xi.value[mm+b][0] += dmeasure[b]/measurement_noise

        dposition=data[i][1]
        for b in range(2):
            Omega.value[k+b][k+b] += 1/motion_noise
            Omega.value[k+b][k+2+b] += -1/motion_noise
            Omega.value[k+2+b][k+b] += -1/motion_noise
            Omega.value[k+2+b][k+2+b] += 1/motion_noise
            Xi.value[k+b][0] += -dposition[b]/motion_noise
            Xi.value[k+2+b][0] += dposition[b]/motion_noise
